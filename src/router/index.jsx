...
const Faculty = React.lazy(() => import("@/components/pages/Faculty"));
const Courses = React.lazy(() => import("@/components/pages/Courses"));
const Departments = React.lazy(() => import("@/components/pages/Departments"));
const Enrollment = React.lazy(() => import("@/components/pages/Enrollment"));
const Attendance = React.lazy(() => import("@/components/pages/Attendance"));
const Tasks = React.lazy(() => import("@/components/pages/Tasks"));
const Deals = React.lazy(() => import("@/components/pages/Deals"));
